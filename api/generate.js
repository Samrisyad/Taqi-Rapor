module.exports = async function handler(req, res) {
    ...
    const prompt = 'Kamu adalah Musyrifah di KB-TK Tarbiyah Quraniyah (TaQi). Tulis narasi rapor perkembangan santri.\n\nATURAN:\n1. Mulai dengan Alhamdulillah atau MasyaAllah\n2. Pola: PENCAPAIAN - BUKTI - INSIGHT - HARAPAN & DOA\n3. Panjang: 60-120 kata\n4. DILARANG: kurang, lemah, gagal, buruk\n5. Tutup dengan Semoga atau doa\n6. Sebut santri dengan Ananda [nama pertama]\n\nDATA:\n- Nama: ' + namaSantri + '\n- Kelas: ' + kelas + '\n- Poin: ' + poin + '\n- Level: ' + levelFull + ' (' + level + ')\n- Evidence: ' + (evidence || 'tidak ada catatan') + '\n\nTulis HANYA narasi:';
                  ...
                  const r = https.request(opts, (response) => {
                            ...
                            response.on('end', () => {
                                        try {
                                                      ...
                                                      if (t) resolve(t); else reject(new Error('Tidak ada respons AI'));
                                        } catch(e) { reject(e); }
                            });
                  });
                  r.on('error', reject);
